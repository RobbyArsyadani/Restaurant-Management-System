...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
        <?= form_open_multipart('admin/edit_food/'.$food['id']); ?>
            <div class="form-group row">
                <label for="id" class="col-sm-2 col-form-label">id</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="pid" name="pid" value="<?= $food['id']; ?>" readonly>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src="<?= base_url('assets/img/products/food/') . $food['image']; ?>" class="img-thumbnail">
                        </div>
                        <div class="col-sm-9">
