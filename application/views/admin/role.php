        ...
        <div class="col-lg-6">
            ...
            <?php if($this->session->flashdata('edit_role') != '') { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    The role's name has been changed!
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    <?php unset($_SESSION['edit_role']); ?>
                </div>
            <?php } ?>
            <?php if($this->session->flashdata('delete_role') != '') { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    The role has been deleted!
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    <?php unset($_SESSION['delete_role']); ?>
                </div>
            <?php } ?>
            <?php if($this->session->flashdata('add_role') != '') { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    The new role's name has been added!
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    <?php unset($_SESSION['add_role']); ?>
                </div>
            <?php } ?>
